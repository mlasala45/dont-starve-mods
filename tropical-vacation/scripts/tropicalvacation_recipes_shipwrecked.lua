...
local shadowportal_recipe = Recipe("shadowportal", {Ingredient("livinglog", 4), Ingredient("nightmarefuel", 4), Ingredient("purplegem", 1)}, shadowportal_tab, shadowportal_level, RECIPE_GAME_TYPE.COMMON, "shadowportal_placer", nil, shadowportal_nounlock)
